...
public class Main {
    public static void main(String[] args) {
        ...
        // Step 3: Dynamically create operators using the factory
        SelectionStrategy selection = OperatorFactory.createSelection("tournament");
        CrossoverStrategy crossover = OperatorFactory.createCrossover("order");
        MutationStrategy mutation = OperatorFactory.createMutation("swap");
